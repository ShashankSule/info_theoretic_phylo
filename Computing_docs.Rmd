...
```{r}
seq_file_names <- paste("./JC69_Jul28/Sequences/sequence",1:105,".nex", sep = "")
tree_file_names <- paste("./JC69_Jul28/Trees/tree",1:105,".txt", sep = "")
seed_file_names <- paste("./JC69_Jul28/Seeds/seed",1:105,".txt", sep = "")
```
...
Running the above code on a list of sequences: 
...
```{r}
putfile <- read_lines("./paml4.8/mlb")
```
