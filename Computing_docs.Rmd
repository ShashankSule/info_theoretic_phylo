...
species_names <- rownames(trial_sequence)
opts <- paml.baseml.control(noisy = 1, 
                            runmode = 2, 
                            model = 6,
                            Mgene = 0,
                            ndata = 1, 
...
paml.baseml(trial_sequence, seqname = rownames(sequences[[1]]), opts = opts)
```
